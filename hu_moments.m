% Hu Moments of order 2 and 3
% This function calculates hu moments acording to the formulas given
% First of all the central moments(mu(i,j)) and center of mass(x_bar,y_bar)
% of the image are calculated according to the formulas given 
...
% defining a co-ordinate system for image 
...
%calculating the first 8 hu moments of order 2 and 3
I_one   = mu_20 + mu_02;
I_two   = (mu_20 - mu_02)^2 + 4*mu_11*mu_11;
...
I_six   = (mu_20 - mu_02)*((mu_30 + mu_12)^2 - (mu_21 + mu_03)^2) + 4*(mu_30 + mu_12)*(mu_21 + mu_03)*mu_11;
I_seven = (3*mu_21 - mu_03)*(mu_30 + mu_12)*((mu_30 + mu_12)^2 - 3*(mu_21 + mu_03)^2) + (3*mu_12 - mu_30)*(mu_21 + mu_03)*(3*(mu_30 + mu_12)^2 - (mu_21 + mu_03)^2);
...
% calculating the scale invariant central moments
